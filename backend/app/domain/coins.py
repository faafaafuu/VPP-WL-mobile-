...
ALL_COINS: tuple[Coin, ...] = (
    Coin("usdt_trc20",   "USDT", "TRC20 (Tron)",     "tether",   "trc20",   2, _USDT, 1),
    Coin("usdt_bep20",   "USDT", "BEP20 (BSC)",       "tether",   "eth",     2, _USDT, 2),
    Coin("usdt_erc20",   "USDT", "ERC20 (Ethereum)",  "tether",   "eth",     2, _USDT, 3),
    Coin("usdt_polygon", "USDT", "Polygon",           "tether",   "polygon", 2, _USDT, 4),
    Coin("usdt_solana",  "USDT", "Solana",            "tether",   "solana",  2, _USDT, 5),
    Coin("usdc_trc20",   "USDC", "TRC20 (Tron)",      "usd-coin", "trc20",   2, _USDC, 6),
    ...
    Coin("ton",          "TON",  "TON Blockchain",    "toncoin",  "ton",     4, "#0098ea", 11),
    Coin("eth",          "ETH",  "Ethereum",          "ethereum", "eth",     6, "#627eea", 12),
    Coin("btc",          "BTC",  "Bitcoin",           "bitcoin",  "btc",     8, "#f7931a", 13),
)
